...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EB3Coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"209.135.140.133","209.135.140.133"},
	{"45.55.143.18","45.55.143.18"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EB3Coin is probably already running."), addrBind.ToString().c_str());
        else
